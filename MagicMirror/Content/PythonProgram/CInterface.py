...
def initRecogModel(model="E:\\DeepLearning\\Clothing Recognition\\protocol\\seven\\model_weights.pkl"):
	...
	#model = os.path.join(Vars.REALPATH, "recognition", "iterative_training", "model_weights_1e+00%.pkl")
	print(model)
	recog.load(model)
...
#Vars.TEXTURE_FOLDER = os.path.join("PythonProgram", "textures") import sys; sys.path.insert(0, 'E:/Unreal Projects/IntelligentMirror/MagicMirror/Content/PythonProgram/');
#Vars.DBFILE = os.path.join("PythonProgram", "shirt_db.db") import CInterface; CInterface.initWithPath('E:/Unreal Projects/IntelligentMirror/MagicMirror/Content/PythonProgram/');
